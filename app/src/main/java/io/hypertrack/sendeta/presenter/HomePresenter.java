...
//                    action.getActionDisplay().setDurationRemaining(String.valueOf(etaInMinutes));
            ...
            public void onError(@NonNull ErrorResponse errorResponse) {
                ...
                AnalyticsStore.getLogger().sharedLiveLocation(false, ErrorMessages.SHARE_LIVE_LOCATION_FAILED);
    ...
    public void stopSharing(ActionManager actionManager) {
        actionManager.completeAction(new ActionManagerCallback() {
            ...
            @Override
            public void OnError() {
                AnalyticsStore.getLogger().tappedStopSharing(false, ErrorMessages.STOP_SHARING_FAILED);
