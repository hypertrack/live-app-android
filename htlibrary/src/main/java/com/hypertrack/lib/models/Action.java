...
public class Action {
    ...
    public Action(String id, User user, String action, Place expectedPlace,
                  Date expectedAT, Place completedPlace, Date completedAT, Date assignedAT,
                  String status, Date ETA, Date initialETA, String trackingURL, String timeAwarePolyline,
                  String encodedPolyline, String distance, Display display, Place startPlace,
                  Date startedAT) {
    ...
    public void setExpectedPlace(Place expectedPlace) {
        this.expectedPlace = expectedPlace;
    }
    ...
    public Place getCompletedPlace() {
        return completedPlace;
    }

    public void setCompletedPlace(Place completedPlace) {
        this.completedPlace = completedPlace;
    }
    ...
    public Display getActionDisplay() {
        return display;
    }
