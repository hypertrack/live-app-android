...
public class HyperTrack {
    ...
    /**
     * Method to assign one or multiple actions to current user
     *
     * @param actionIds Pass a list of Action Ids to be assigned to the
     * @param callback  Pass instance of HyperTrack callback as parameter
     */
    public static void assignActions(@NonNull List<String> actionIds, @NonNull HyperTrackCallback callback) {
        HyperTrackImpl.getInstance().assignActions(actionIds, callback);
    }

    /**
     * Method to get Action model for a given actionId
     *
    ...
    public static void getAction(@NonNull String actionId, @NonNull HyperTrackCallback callback) {
        HyperTrackImpl.getInstance().getAction(actionId, callback);
    }
    ...
    public static boolean setServiceNotificationParams(final ServiceNotificationParams notificationParams) {
        return HyperTrackImpl.getInstance().setServiceNotificationParams(notificationParams);
    }
