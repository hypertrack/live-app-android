...
public class HTServiceNotificationUtils {
    ...
    private static PendingIntent getNotificationPendingIntent(Context context) {
        ...
        if (intent != null) {
            ...
            intent.putExtra(HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_TYPE,
                    HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_TYPE_NOTIFICATION_CLICK);
            intent.putStringArrayListExtra(HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_EXTRAS_LIST,
        ...
        if (actionParamsList != null && !actionParamsList.isEmpty()) {
            ...
            for (ServiceNotificationAction actionParams : actionParamsList) {
                ...
                if (!TextUtils.isEmpty(actionClassName)) {
                    ...
                    actionIntent.putExtra(HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_TYPE,
                            HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_TYPE_ACTION_CLICK);
                    actionIntent.putExtra(HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_ACTION_TEXT,
                            actionParams.getActionText());
                    actionIntent.putStringArrayListExtra(HyperTrackConstants.HT_SERVICE_NOTIFICATION_INTENT_EXTRAS_LIST,
