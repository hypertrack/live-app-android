...
import com.hypertrack.lib.internal.consumer.models.TaskListResponse;
...
public class HTTPClient {
    ...
    private HTTPPostRequest getHTCustomPostRequest(final HyperTrackPostRequest httpPostRequest) {
        try {
            ...
            } else if (responseType == HTTask.class) {
                return new HTTPPostRequest<>(httpPostRequest.getUrl(), getRequestHeaders(httpPostRequest),
                        httpPostRequest.getRequestBody().toString(), this.mContext, HTTask.class,
            ...
            } else if (responseType == User.class) {
                return new HTTPPostRequest<>(httpPostRequest.getUrl(), getRequestHeaders(httpPostRequest),
                        httpPostRequest.getRequestBody().toString(), this.mContext, User.class,
    ...
    private HTTPGetRequest getHTCustomGetRequest(final HyperTrackGetRequest httpGetRequest) {
        ...
        } else if (responseType == TaskListResponse.class) {
            return new HTTPGetRequest<>(httpGetRequest.getUrl(), getRequestHeaders(httpGetRequest),
                    null, this.mContext, TaskListResponse.class,
        ...
        } else if (responseType == Action.class) {
            return new HTTPGetRequest<>(httpGetRequest.getUrl(), getRequestHeaders(httpGetRequest),
                    null, this.mContext, Action.class,
                    new Response.Listener<Action>() {
                        @Override
