...
2. [Signup](https://www.hypertrack.com/signup?utm_source=github&utm_campaign=ht_live_android) to get your [HyperTrack API keys](https://dashboard.hypertrack.com/settings). Add the **publishable key** to [key.properties](https://github.com/hypertrack/hypertrack-live-android/blob/master/app/src/debug/java/io/hypertrack/sendeta/key.properties) file.
```java
